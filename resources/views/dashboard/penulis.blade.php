...
<body class="bg-gray-50 text-slate-900">
    ...
    <div id="modalArtikel" class="fixed inset-0 z-50 hidden">
        ...
        <div class="absolute inset-0 flex items-center justify-center p-4">
            <div id="modalContent" class="bg-white w-full max-w-2xl rounded-[40px] shadow-2xl overflow-hidden transform transition-all scale-95 opacity-0">
                ...
                <form action="{{ route('berita.store') }}" method="POST" enctype="multipart/form-data" class="p-10 space-y-6">
                    @csrf
                    <div>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="file" name="foto" required
                                   class="w-full text-xs text-slate-400 file:mr-4 file:py-4 file:px-6 file:rounded-2xl file:border-0 file:text-[10px] file:font-black file:uppercase file:tracking-widest file:bg-indigo-50 file:text-indigo-600 hover:file:bg-indigo-100 cursor-pointer">
                        </div>
                    </div>

                    <div>
                        <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-3">Isi Berita</label>
                        <textarea name="isi_berita" rows="6" required 
